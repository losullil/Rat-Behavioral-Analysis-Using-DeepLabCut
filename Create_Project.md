...
Before you go on, now is a good time to specify which bodyparts you are labeling. For my project, I am labeling 13 different body parts in the rat. To do so, click "Edit Config File", then allow a Firefox window to open (sometimes there is a delay on this). Allow the config file to open in plume, then you should see something like this. 

<img width="1023" alt="image" src="https://user-images.githubusercontent.com/86625869/190880827-0ecb7d57-7364-40cd-976a-ca5445580c9e.png">

You will list the bodyparts you are working with under "bodyparts". If you are going to make use of the skeleton, you should also change the corresponding names. 

<img width="980" alt="image" src="https://user-images.githubusercontent.com/86625869/190880903-1bf633be-5b6b-4986-bdcb-91a7512dc743.png">
